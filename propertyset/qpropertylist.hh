...
namespace UFG
{
	...
	public:
		...
		void Add(const qPropertyList* v) { SDK_CALL_FUNC(void, 0x1E8D10, void*, const qPropertyList*)(this, v); }
		void Add(const qPropertySet* v) { SDK_CALL_FUNC(void, 0x1E8D30, void*, const qPropertySet*)(this, v); }
