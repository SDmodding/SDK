...
namespace UFG
{
	...
	{
		{ Weapon_firearm_camera_pda, "Camera (PDA)" },
		{ Weapon_firearm_fireextinguisher_fireextinguisher, "Fire Extinguisher" },
		{ Weapon_firearm_pistol_45cal, "Pistol 45Cal" },
		{ Weapon_firearm_pistol_45cal_taclight, "Pistol 45Cal (Taclight)" },
		{ Weapon_firearm_pistol_50cal_silver, "Pistol 50Cal" },
		{ Weapon_firearm_pistol_50cal_gold, "Pistol 50Cal (Gold)" },
		{ Weapon_firearm_pistol_9mm, "Pistol 9mm" },
		{ Weapon_firearm_pistol_HandGun_Hitman001, "Silver Baller Pistol" },
		{ Weapon_firearm_pistol_HandGun_JC2001, "Rico Rodriguez's Revolver" },
		{ Weapon_firearm_rifle_Rifle_DeusEx001, "FR-27 Rifle" },
		{ Weapon_firearm_rifle_assault, "QBZ-95" },
		{ Weapon_firearm_rifle_assault_taclight, "QBZ-95 (Taclight)" },
		{ Weapon_firearm_rifle_grenade, "L85A2 (Grenade)" },
		{ Weapon_firearm_shotgun_antiriotnolight, "Anti-Riot Shotgun" },
		{ Weapon_firearm_shotgun_antiriot_taclight, "Anti-Riot Shotgun (Taclight)" },
		{ Weapon_firearm_shotgun_pump, "Pump Shotgun" },
		{ Weapon_firearm_smg_45cal, "SMG 45Cal" },
		...
		{ Weapon_melee_briefcase, "Briefcase" },
		{ Weapon_melee_cleaver, "Cleaver" },
		{ Weapon_melee_cleaver_Gold, "Cleaver (Gold)" },
		{ Weapon_melee_CookingWok001, "Cooking Wok" },
		{ Weapon_melee_crowbar, "Crowbar" },
		{ Weapon_melee_CombatFish001, "Fish" },
		{ Weapon_melee_GroceryBag_Hand, "Shopping Bag" },
		{ Weapon_melee_SwordTaiChi001, "Peachwood Sword" },
		{ Weapon_melee_SwordAnime001, "Lightning Warrior Sword" },
		...
		{ Weapon_melee_PurseHand001_Hand, "Purse" },
		{ Weapon_melee_GameGuitar001, "Guitar" },
		{ Weapon_melee_BullPenis001, "Bull Penis" },
		{ Weapon_melee_CookingPan001, "Cooking Pan" },
		{ Weapon_melee_Shovel001, "Shovel" },
		{ Weapon_melee_StaffMonkeyKing001, "Staff Monkey King" },
		{ Weapon_melee_nightstick, "Retractable Combat Baton" },
		{ Weapon_melee_Wrench001, "Wrench" },
		{ Weapon_melee_hammer, "Hammer" }
	};

	unsigned int m_WeaponIDs[] = { Weapon_firearm, Weapon_firearm_camera_pda, Weapon_firearm_fireextinguisher_fireextinguisher, Weapon_firearm_pistol_45cal, Weapon_firearm_pistol_45cal_taclight, Weapon_firearm_pistol_50cal, Weapon_firearm_pistol_50cal_gold, Weapon_firearm_pistol_50cal_gold_hd, Weapon_firearm_pistol_50cal_silver, Weapon_firearm_pistol_9mm, Weapon_firearm_pistol_HandGun_Hitman001, Weapon_firearm_pistol_HandGun_JC2001, Weapon_firearm_pistol_service, Weapon_firearm_rifle_DLC_MGL, Weapon_firearm_rifle_Rifle_DeusEx001, Weapon_firearm_rifle_assault, Weapon_firearm_rifle_assault_dlc, Weapon_firearm_rifle_assault_taclight, Weapon_firearm_rifle_assault_vehiclemounted, Weapon_firearm_rifle_grenade, Weapon_firearm_rifle_grenade_hd, Weapon_firearm_rifle_turret, Weapon_firearm_shotgun_antiriot_taclight, Weapon_firearm_shotgun_antiriotnolight, Weapon_firearm_shotgun_hunter, Weapon_firearm_shotgun_pump, Weapon_firearm_smg_45cal, Weapon_firearm_smg_45cal_gold, Weapon_firearm_smg_45cal_taclight, Weapon_firearm_smg_machine_pistol, Weapon_melee, Weapon_melee_BagJacket001, Weapon_melee_Basketball001, Weapon_melee_BeerBottle002, Weapon_melee_BottleGourd001, Weapon_melee_BottledSoftDrink001, Weapon_melee_BottledSoftDrink001_A, Weapon_melee_BottledSoftDrink001_B, Weapon_melee_BroomFull001, Weapon_melee_BroomFull002, Weapon_melee_BroomWeapon001, Weapon_melee_BullPenis001, Weapon_melee_CellPhone001, Weapon_melee_Chair_BasicWooden002, Weapon_melee_Chair_MetalFolding001, Weapon_melee_CombatFish001, Weapon_melee_CookingPan001, Weapon_melee_CookingPot001, Weapon_melee_CookingSpoon001, Weapon_melee_CookingWok001, Weapon_melee_DuffleBag001, Weapon_melee_ElectroWeapon001, Weapon_melee_GameGuitar001, Weapon_melee_GroceryBag, Weapon_melee_GroceryBag_Hand, Weapon_melee_HandGrinder001, Weapon_melee_HandcuffsHQ001, Weapon_melee_Lime001, Weapon_melee_MacheteTong001, Weapon_melee_MissionCellPhone001, Weapon_melee_Orange001, Weapon_melee_PaintCan001, Weapon_melee_PaintCan001_A, Weapon_melee_PaintCan001_B, Weapon_melee_PicketSign001, Weapon_melee_PicketSign002, Weapon_melee_PicketSign003, Weapon_melee_PopCan_A, Weapon_melee_PopCan_B, Weapon_melee_PopCan_ShugaA, Weapon_melee_PopCan_ShugaB, Weapon_melee_PopCan_ShugaC, Weapon_melee_PopCan_ShugaD, Weapon_melee_Purse001_Elbow, Weapon_melee_Purse001_Hand, Weapon_melee_Purse001_Shoulder, Weapon_melee_Purse002, Weapon_melee_Purse002_Elbow, Weapon_melee_Purse002_Hand, Weapon_melee_Purse002_Shoulder, Weapon_melee_PurseHand001_Elbow, Weapon_melee_PurseHand001_Hand, Weapon_melee_RawFish001, Weapon_melee_Shovel001, Weapon_melee_StaffMonkeyKing001, Weapon_melee_SwordAnime001, Weapon_melee_SwordTaiChi001, Weapon_melee_TableLegClub001, Weapon_melee_TelescopingBaton001, Weapon_melee_Wrench001, Weapon_melee_bag, Weapon_melee_baton, Weapon_melee_beerbottle, Weapon_melee_briefcase, Weapon_melee_briefcase_alum, Weapon_melee_briefcasealuminum, Weapon_melee_cane, Weapon_melee_canewalking, Weapon_melee_carbomb, Weapon_melee_cleaver, Weapon_melee_cleaver_A, Weapon_melee_cleaver_Gold, Weapon_melee_crowbar, Weapon_melee_hackbroom, Weapon_melee_hammer, Weapon_melee_kitchenknife, Weapon_melee_nightstick, Weapon_melee_popcan, Weapon_melee_purse, Weapon_melee_pursehand, Weapon_melee_scrubbrush, Weapon_melee_squeegee, Weapon_melee_stickbamboo, Weapon_melee_sticktree, Weapon_melee_throwable, Weapon_melee_tireiron, Weapon_melee_umbrella, Weapon_melee_woodenclub, Weapon_melee_woodenstick, static_cast<unsigned int>(-1) };
}