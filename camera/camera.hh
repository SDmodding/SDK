...
namespace UFG
{
	...
	public:
		...
		qVector3 GetScreenCoord(const qVector3& world_pos, const qVector2& viewport_scale, bool* is_on_screen = 0) 
		{
			qVector3 res;
			return *SDK_CALL_FUNC(qVector3*, 0xB9B70, void*, qVector3*, const qVector3&, const qVector2&, bool*)(this, &res, world_pos, viewport_scale, is_on_screen);
		}
		...
		qVector3 ScreenToWorldRay(const qVector2& screen_pos, const qVector2& viewport_scale)
		{
			qVector3 res;
			return *SDK_CALL_FUNC(qVector3*, 0xBA0B0, void*, qVector3*, const qVector2&, const qVector2&)(this, &res, screen_pos, viewport_scale);
		}
