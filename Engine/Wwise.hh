...
namespace UFG
{
	namespace WwiseInterface
	{
		...
		UFG_INLINE bool PrepareMP3(const char* m_FileName)
		{
			return reinterpret_cast<bool(__fastcall*)(const char*)>(UFG_RVA(0x14AC60))(m_FileName);
		}

		UFG_INLINE bool LoadFilePackage(qSymbol m_DeviceName, const char* m_PackageName, bool m_Localized = false, bool m_DLC = false)
		{
		...
		UFG_INLINE void UnloadFilePackage(const char* m_PackageName)
		{
