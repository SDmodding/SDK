...
namespace UFG
{
	...
	public:
		...
		__inline float GetAdjustedScale()
		{
		...
		__inline void MinimapTilePointOffset(MinimapTilePoint2f* p_MinimapTilePoint, MinimapPoint2f* p_MinimapPoint)
		{
		...
		void MinimapTilePoint(MinimapTilePoint2f* p_MinimapTilePoint, ScreenPoint2f* p_ScreenPoint)
		{
		...
		void ScreenPoint(ScreenPoint2f* p_ScreenPoint, WorldPoint2f* p_WorldPoint)
		{
			reinterpret_cast<void(__fastcall*)(ScreenPoint2f*, WorldPoint2f*, void*)>(UFG_RVA(0xBB880))(p_ScreenPoint, p_WorldPoint, this);
		}
		
		void WorldPoint(WorldPoint2f* p_WorldPoint, ScreenPoint2f* p_ScreenPoint)
		{
			reinterpret_cast<void(__fastcall*)(WorldPoint2f*, ScreenPoint2f*, void*)>(UFG_RVA(0xBD2D0))(p_WorldPoint, p_ScreenPoint, this);
		}

		void InitFromMinimapTilePos(ScreenPoint2f* p_ScreenPoint, MinimapTilePoint2f* p_MinimapTilePoint)
		{
		...
		void InitFromWorldPos(ScreenPoint2f* p_ScreenPoint, WorldPoint2f* p_WorldPoint)
		{
