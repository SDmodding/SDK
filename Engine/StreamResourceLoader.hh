...
namespace UFG
{
	namespace StreamResourceLoader
	{
		...
		public:
			...
			UFG_INLINE bool LoadInternal()
			{
				return reinterpret_cast<bool(__fastcall*)(CLoadedFile*)>(UFG_RVA(0x22ACF0))(this);
			}

			UFG_INLINE void UnloadInternal()
			{
				reinterpret_cast<void(__fastcall*)(CLoadedFile*)>(UFG_RVA(0x22EB60))(this);
			}
		};

		UFG_INLINE int64_t Load(void* p_Buffer, int64_t p_NumBytes, const char* p_DebugIdentifier = nullptr, uint32_t p_DataType = 1, void* p_FilterCallback = nullptr)
		{
		...
		UFG_INLINE  bool LoadResourceFile(const char* p_FileName, CMemoryPool* p_MemoryPool = nullptr, uint32_t p_AllocFlags = 0, void* p_Filter = nullptr, void* p_Callback = nullptr, void** p_CallbackParam = nullptr)
		{
