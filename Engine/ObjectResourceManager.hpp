...
namespace UFG
{
	...
	public:
		...
		__inline bool HasStreamedResource(qPropertySet* m_PropertySet)
		{
		...
		__inline bool IsLoaded(qPropertySet* m_PropertySet)
		{
		...
		__inline void PreLoadCriticalResource(qPropertySet* m_PropertySet)
		{
			if (HasStreamedResource(m_PropertySet))
				reinterpret_cast<void(__fastcall*)(void*, qPropertySet*)>(UFG_RVA(0x43FBE0))(this, m_PropertySet);
		}

		__inline void ReleaseCriticalResource(qPropertySet* m_PropertySet)
		{
			if (HasStreamedResource(m_PropertySet))
