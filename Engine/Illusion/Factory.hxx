...
namespace Illusion
{
	namespace Factory
	{
		...
		__inline CTexture* NewTexture(const char* p_Name, uint32_t p_NameUID, class CMemImageSceham* p_Schema = nullptr, UFG::CMemoryPool* p_MemoryPool = nullptr, uint64_t p_AllocationParams = 0)
		{
