...
public:
	...
	hkpReorientAction() { SDK_CALL_FUNC(void, 0xE12FE0, void*)(this); }
	hkpReorientAction(hkpRigidBody* body, const hkVector4f& rotationAxis, const hkVector4f& upAxis, f32 strength = 1.f, f32 damping = 0.1f) {
